...
export default function UserRegister() {
  ...
  const handleDeleteUser = async (userId) => {
    if (!window.confirm(`Remove user ${userId} permanently?`)) return;
    ...
    try {
      ...
      // Optional: also call context if you still use it
      if (removeUser) removeUser(userId);
      ...
      <div className="bg-white border border-gray-100 p-4 rounded-2xl shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 self-end md:self-auto">
          ...
          <button
            ...
            className="h-[36px] px-3 border border-gray-200 rounded-xl bg-white text-slate-500 hover:text-blue-600 hover:border-blue-300 transition flex items-center gap-1.5 text-xs font-bold disabled:opacity-60"
          >
              ...
              {loading ? (
                <tr>
                  <td colSpan="5" className="py-12 text-center">
                    <RefreshCw size={28} className="mx-auto animate-spin text-blue-500 mb-2" />
                ...
                <tr>
                  <td colSpan="5" className="py-14 text-center">
                    <div className="flex flex-col items-center gap-2 text-slate-400">
                      <Users size={32} className="opacity-60" />
                      <p className="text-sm font-semibold text-red-500">No users found</p>
                    </div>
                  </td>
                </tr>
              ) : (
