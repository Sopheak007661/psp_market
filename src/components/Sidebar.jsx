...
// import { BarChart3, PlusCircle, ClipboardList, ArrowLeft, ShieldAlert } from 'lucide-react';
...
//                 className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-xs font-semibold transition ${currentView === item.id ? 'bg-green-600 text-white' : 'hover:bg-gray-800 text-gray-900 hover:text-gray-200'}`}
//               >
...
//         </nav>
//       </div>
//       <button onClick={() => setView('shop-home')} className="w-full flex items-center space-x-2 justify-center border border-gray-800 hover:border-gray-700 text-gray-300 px-4 py-2.5 rounded-xl text-xs font-semibold transition bg-gray-800/30">
