...
export const ShopProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch('https://backend-psp-market.onrender.com/api/products')
      .then(res => {
  ...
  const addProduct = async (product) => {
    try {
      const response = await fetch('https://backend-psp-market.onrender.com/api/products', {
        method: 'POST',
  ...
  const deleteProduct = async (id) => {
    try {
      const response = await fetch(`https://backend-psp-market.onrender.com/api/products/${id}`, {
        method: 'DELETE',
      });
